...
export default function Navbar(){
  ...
  <h1 class="text-xl text-gray-800 font-bold">MediCore</h1>
  <div class="flex items-center">
    ...
    <ul class="flex items-center space-x-6">
      ...
      <li class="font-semibold text-gray-700">Contact</li>
      <li class="font-semibold text-gray-700">Service</li>
      <li class="font-semibold text-gray-700">Admin</li>
      <li class="font-semibold text-gray-700">Help</li>
      <li>
